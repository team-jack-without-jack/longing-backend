...
public class QLocationEntity extends EntityPathBase<LocationEntity> {
    ...
    private static final long serialVersionUID = -1333415877L;
    ...
    public final com.longing.longing.api.category.infrastructure.QCategoryEntity category;
    ...
    public QLocationEntity(Class<? extends LocationEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new com.longing.longing.api.category.infrastructure.QCategoryEntity(forProperty("category")) : null;
