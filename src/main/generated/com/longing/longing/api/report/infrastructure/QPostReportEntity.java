...
public class QPostReportEntity extends EntityPathBase<PostReportEntity> {
    ...
    private static final long serialVersionUID = 2021028921L;
    ...
    public final com.longing.longing.api.user.infrastructure.QUserEntity reporter;

    public final EnumPath<com.longing.longing.api.report.ReportReason> reportReason = createEnum("reportReason", com.longing.longing.api.report.ReportReason.class);
    ...
    public QPostReportEntity(Class<? extends PostReportEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reporter = inits.isInitialized("reporter") ? new com.longing.longing.api.user.infrastructure.QUserEntity(forProperty("reporter")) : null;
    }
